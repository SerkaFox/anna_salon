...
urlpatterns = [
    ...
    path("voy/<str:token>/", booking_views.booking_short_response, {"action": "voy"}, name="booking_attend"),
    path("no/<str:token>/", booking_views.booking_short_response, {"action": "no"}, name="booking_decline"),
    ...
    path("app-start/", core_views.app_start, name="app_start"),
