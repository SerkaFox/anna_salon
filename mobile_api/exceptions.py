...
RU_ERROR_TRANSLATIONS = {
    ...
    "Las credenciales de autenticación no se proveyeron.": "Необходимо войти в приложение.",
    "Las credenciales de autenticación son incorrectas.": "Неверный логин или пароль.",
    ...
    "Usted no tiene permiso para realizar esta acción.": "Недостаточно прав для выполнения этого действия.",
    "Not found.": "Объект не найден.",
    "No encontrado.": "Объект не найден.",
    "Unknown kind.": "Неизвестный тип данных.",
    "This field is required.": "Заполните обязательное поле.",
    "Este campo es requerido.": "Заполните обязательное поле.",
    "This field may not be null.": "Обязательное поле не может быть пустым.",
    "Este campo no puede ser nulo.": "Обязательное поле не может быть пустым.",
    "This field may not be blank.": "Заполните обязательное поле.",
    "Este campo no puede estar en blanco.": "Заполните обязательное поле.",
    ...
    "Introduzca una dirección de correo electrónico válida.": "Укажите корректный адрес электронной почты.",
